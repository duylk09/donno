...
import jsonData from './data_occ_d01.json'; 
    ...
    return(
        <>
            ...
            <div>
                ...
                <select id="year" name="year" defaultValue="" onChange={(e) => handleYearChange}>
            ...
            <div>
                ...
                <select id="nationality" name="nationality" defaultValue="" onChange={(e) =>handleNationalityChange}>
                    <option key="default" value=""></option>
            ...
            {/* Select box: Industy */}
            <div>
                <label htmlFor="industry">Select Industy:</label>
                <select id="industry" name="industry" defaultValue="" onChange={(e) =>handleIndustryChange}>
                    <option key="default" value=""></option>
            ...
            <div>
                ...
                <select id="occupation" name="occupation" defaultValue="" onChange={(e) =>handleOccupationChange}>
                    <option key="default" value=""></option>
            ...
            <div>Applications: {application}</div>
        </>
    )
